export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf6d82f0460b98f30",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8e6f57efed497c3d8b2bbb531e365665",
  ...
  USERS: [
    {
      ...
      id: "oXgBd5sMyPRQ8GdLq_kEm5vIyPyU",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "JF5J2kqc1Q5RYz7dODPUh3prmCOfw9fHOa8wMwABDYw",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "济南",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2002", "date": "04-01"},
